...
namespace QuantBlackTrading
{
    ...
    {
        static string FeatureBuildPath = "\"G:\\My Drive\\Python Projects\\MarketClustering\\build_features.py\"";
        ...
        public static void PythonFeatureBuilder(Asset asset, ExternalFeatureData externalFeatureData, MessageDelegate messageDelegate = null)
        {
