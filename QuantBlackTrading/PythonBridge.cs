...
namespace QuantBlackTrading
{
    ...
    {
        public string PythonPath = "C:\\Users\\matth\\Anaconda3\\python";
        ...
        private Process getPythonProcess(string executeName)
        {
            ...
            p.StartInfo = new ProcessStartInfo("cmd", "/K " + executeName + " & exit")
            {
        ...
        {
            Process p = getPythonProcess(PythonPath + " " + path);
